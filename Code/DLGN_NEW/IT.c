...
#define castate castate__it 
#define evaluate_fct evaluate_fct__it 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 it C:/Users/brndn/OneDrive/Desktop/DLGN_NEW/IT.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "IT.mod";
static const char* nmodl_file_text = 
