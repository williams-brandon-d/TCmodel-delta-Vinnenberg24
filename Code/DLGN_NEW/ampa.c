...
#define Cdur Cdur_AMPA_S
 double Cdur = 0.3;
#define Cmax Cmax_AMPA_S
 double Cmax = 0.5;
#define Deadtime Deadtime_AMPA_S
 double Deadtime = 1;
#define Erev Erev_AMPA_S
 double Erev = 0;
#define Prethresh Prethresh_AMPA_S
 double Prethresh = 0;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 AMPA_S C:/Users/brndn/OneDrive/Desktop/DLGN_NEW/ampa.mod\n");
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 113 in file ampa.mod:\n	SOLVE release\n"); nrn_complain(_p); abort_run(error);}
 }}}
